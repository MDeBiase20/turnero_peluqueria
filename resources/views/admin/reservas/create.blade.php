        ...
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <!-- /.card-tools -->
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ url('admin/reservas/create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label for="fecha">Fecha</label>
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="date" id="fecha" class="form-control" name="fecha" value="{{ old('fecha') }}" required>
                                                </div>
                                                @error('fecha')
                                                    <small style="color: red">{{ $message }}</small>    
                                                @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="hora_reserva" id="hora_reserva">
                                        ...
                                        <div class="form-group">
                                            <label for="logo">Comprobante de pago</label>
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="file" id="file" name="comprobante_pago" class="form-control" name="foto" accept=".pdf" required>
                                                </div>
                                            @error('foto')
                                                <small style="color:red;"> {{ $message }} </small>
                                            @enderror
                                            ...
                                            <div class="text-center mt-2">
                                                <output style="padding= 10px" id="list">
                                                    @if (isset($reserva->comprobante_pago))
                                                        <img class="thumb thumbnail" src="{{ url($reserva->comprobante_pago) }}" width="50%" title= "{{ $reserva->comprobante_pago }}"/>
                                                    @endif
                                                </output>
                                            </div>    
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="telefono">Referencia celular</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Ingrese un número de teléfono" name="ref_celular" value="{{ old('ref_celular') }}" required>
                                            </div>
                                            @error('ref_celular')
                                                <small style="color: red">{{ $message }}</small>    
                                            @enderror
...
@section('css')
    ...
    <style>
            .hora-seleccionada {
        box-shadow: 0 0 0 3px #0d6efd inset !important; /* azul tipo Bootstrap */
